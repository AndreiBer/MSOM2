...
namespace Laser.Parameter
{
    public static class LaserParameter
    {
        ...
        public static int PockelscellDelayMin = 215;
        ...
        public static double LaserMinAllowedWavelength = 400;
        public static double LaserMaxAllowedWavelength = 700;
        public static double LaserDefaultWavelength = 532;
        public static double SystemMinAllowedWavelength = 400;
        public static double SystemMaxAllowedWavelength = 700;
        public static string CurrentState = "";
        public static double minWaveLength = 400;
        public static double maxWaveLength = 700;
